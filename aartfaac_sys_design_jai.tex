...
infrastructure of the  AARTFAAC system, and acts as a  liaison between the
...
i.e. what subbands to  listen to and how many to combine to form an image.
The call-graph initiates  everything at  1 (stations, aartfaac tv,  calibration
pipelines) by connecting to the appropreate clients and starting the processes.
When at least $1$ out of $n$ pipelines is started  and the stations are
functioning properly it calls everything at  $2$ (correlators and imaging
...
will be sent when an error occurs or when an observation successfully
started.\\
